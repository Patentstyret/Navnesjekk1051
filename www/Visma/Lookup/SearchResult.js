(function() {
    Visma.Lookup.SearchResult = function(jsonObj) {
        ...
        //var _jqueryOnErrorScript = "$(this).closest('div').hide()";
        ...
        **/
        (function() {
            ...
            //_thumbnailURL = _thumbnailURL.replace('ws.patentstyret.no', 'web-009:8080');
            ...
            _container.append('<div class="searchResultMeta normalText"><div class="searchResultApplicantInfo"><div class="searchResultApplicationNumber">' + _applicationNumber + '</div><div class="searchResultApplicant">' + _applicant + '</div></div><div class="searchResultStatus subtitleText">' + _status + '</div></div>');
