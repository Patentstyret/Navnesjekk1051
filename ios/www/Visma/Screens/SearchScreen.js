        ...
        **/
        var _populate = function(result) {
            ...
            for(var i = startPage; i <= endPage; i++) {
                if(i == _currentPage) {
                    $(_bottomNavigationBar).append('&nbsp;&nbsp;<b><span class="pageNav normalText">' + i + '</span></b>&nbsp;&nbsp;');
                } else {
                    $(_bottomNavigationBar).append('&nbsp;&nbsp;<span class="pageNav normalText">' + i + '</span></b>&nbsp;&nbsp;');
                }
            }
              ...
              $(_brreg).text(Localization.getString("waitingForResponseBRREG"));
               ...
               if(data.getResultCount() == "0"){
                   ...
                   $(_brreg).click(function () {
                       window.open('https://www.brreg.no/bedrift/samordnet-registermelding', '_system');
